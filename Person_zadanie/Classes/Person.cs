...
namespace Person_zadanie.Classes
{
    internal class Person
    {
        ...
        //Konstuktory 
        public Person(string name, string lastName, int age, double height, double weight, int iq)
        {
            Id = generateUniqueID();
            Name = name;
            LastName = lastName;
        ...
        public double? Weight
        {
            ...
            set
            {
                if (value >= 700 || value <= 60 || value == null)
                    weight = -1;
                else
                {
                    weight = (double)value;
        ...
        public void ChangeHeight()
        {
            ...
            Console.WriteLine($"Old Height  {height} -> New height {inp}");
            height = inp;
        }
        public void ChangeWeight()
        {
            ...
            double inp = Int64.Parse(Console.ReadLine());
            Console.WriteLine($"Old Weight  {weight} -> New weight {inp}");
            weight = inp;
        }
        ...
        public void ChangeIq()
        {
            ...
            int inp = Int32.Parse(Console.ReadLine());
            Console.WriteLine($"Old Iq  {iq} -> New iq {inp}");
            iq = inp;
        }
